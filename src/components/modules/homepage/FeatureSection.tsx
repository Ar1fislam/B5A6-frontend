...
export default function FeatureSection() {
    ...
    setFeatures([
  {
    ...
    description:
      "Enjoy a smooth, unified experience whether you're on your phone, tablet, or desktop.",
  },
  {
    icon: <Shield className="h-8 w-8 text-green-500" />,
    title: "Robust Protection",
    description:
      "Your privacy and funds are safeguarded with state-of-the-art security standards.",
  },
  {
    icon: <CreditCard className="h-8 w-8 text-[var(--primary)]" />,
    title: "Global Transfers",
    description:
      "Move money worldwide instantly—Wallet Nest connects you to anyone, anywhere.",
  },
  {
    icon: <Users className="h-8 w-8 text-orange-500" />,
    title: "Group Accounts",
    description:
      "Set up shared wallets to efficiently manage expenses with friends, family, or coworkers.",
  },
]);
